...
public class ListaProductosFragment extends Fragment {
    ...
    private void obtenerDatos(Integer myIntegerOffset) {
        MercadoLibreApi myMercadoLibreApi = myRetrofit.create(MercadoLibreApi.class);
        Call<ProductoResults> myCallProductoResults = myMercadoLibreApi.obtenerListaProductosPorBusqueda("pc", 30, myIntegerOffset);
